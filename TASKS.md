...
| T05 | Node-RED Docker, flow, Dashboard 6 trang | Lê Hậu | DONE | `node-red/`, Dashboard local. |
...
| T09 | Smart Coach F1–F12, profile, Eco mode, báo cáo và guided demo | Cả nhóm | DONE | Dashboard, firmware v0.3.0, E2E 16/16. |
